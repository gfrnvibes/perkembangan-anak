                ...
                <div class="col-12 col-md-6 col-xl-6">
                    <div class="d-flex">
                        <div class="col-12 col-xl-9">
                            ...
                            <p class="lead mb-5">Mari hadir dalam setiap capaian kecil Ananda, karena cinta orang tua adalah
                                kekuatan utamanya.</p>
                            <div class="text-end">
                        ...
                        <div class="card-body p-3 p-md-4 p-xl-5">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-4">
                                        <h3>Masuk</h3>
                                        <p class="text-secondary">Gunakan Email dan Password yang sudah dikirimkan.</p>
                                    </div>
                                </div>
                            </div>
