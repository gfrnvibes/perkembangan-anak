            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-xxl-5 offset-xxl-1 col-xl-6 col-lg-6 col-12 d-lg-flex justify-content-end">
                    <div class="mt-12 mt-lg-0 position-relative">
                        <div class="">
                            <img src="https://www.educastudio.com/uploads/news/1262433053_20230416_110331.png" alt="graphics-2" class="w-100 rounded-2">
                        </div>
            ...
            <div class="col-md-4 col-12">
                ...
                <div class="card mb-4 mb-lg-0 border-0 shadow-sm">
                    ...
                    <div class="card-body p-5">
                        <!-- icon -->
                        <div class="mb-3"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                                fill="currentColor" class="bi bi-graph-up-arrow text-warning" viewBox="0 0 16 16">
